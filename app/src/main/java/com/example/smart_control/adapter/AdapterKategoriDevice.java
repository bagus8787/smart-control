...
public class AdapterKategoriDevice extends RecyclerView.Adapter<AdapterKategoriDevice.KategoriDeviceViewHolder>{
    private ArrayList<Artikel> artikels;
    private ArrayList<Artikel> artikelsArrayartikels;
    private Context context;
    private SharedPrefManager sharedPrefManager;

    public AdapterKategoriDevice(Context context){
    ...
    @NonNull
    @Override
    public KategoriDeviceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_list_kategori_device, parent, false);

        return new KategoriDeviceViewHolder(view);
//        return null;
    }

    @Override
    public void onBindViewHolder(@NonNull KategoriDeviceViewHolder holder, int position) {
    ...
    public void setKategoriDevice(ArrayList<Artikel> artikels){
...
//        setModel Artikel ke aritkel baru
    ...
    public class KategoriDeviceViewHolder extends RecyclerView.ViewHolder{
        View mView;
        int id;
        ...
        public KategoriDeviceViewHolder(View itemView){
            super(itemView);
            mView = itemView;
...
//                    );
        ...
        public void setJudul (String judul){
            this.judul = judul;
            rvJudul = mView.findViewById(R.id.txt_nama_kategori);
            rvJudul.setText(judul);
