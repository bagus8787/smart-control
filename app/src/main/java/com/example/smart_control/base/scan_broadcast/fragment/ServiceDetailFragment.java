...
import com.example.smart_control.base.scan_broadcast.ServiceDetailViewModel;
import com.example.smart_control.base.scan_broadcast.TxtRecordsAdapter;
...
public class ServiceDetailFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider.AndroidViewModelFactory(Myapp.getApplication(requireContext()))
